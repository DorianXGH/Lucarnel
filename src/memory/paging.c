    ...
    for (int i = 0; i < 512; i++)
    {
        for (int j = 0; j < 512; j++)
        {
            pdpt[i][j] = (struct PDPTE){
                ...
                1,                                  // 1G page
                0,                                  // nullbits
                ((i % 256) * 512 | j) << (30 - 12), // address (*1G) higher half
                0,                                  // reserved nullbits
                0                                   // enables execution
            };
        }
        pml4[i] = (struct PML4E){
            ...
            0,                        // ignored
            0,                        // nullbits
            ((uintptr_t)pdpt[i] & 0x7fffffff) >> 12, // address of page
            0,                        // nullbits
            0                         // allow execution
        };
    }
    pdpt[511][510] = (struct PDPTE){
        1,                        // present
        1,                        // Read/Write
        1,                        // Supervisor
        0,                        // write back
        ...
        1,                        // 1G page
        0,                        // nullbits
        (0l) << (30 - 12), // address (*1G) higher half
        0,                        // reserved nullbits
        0                         // enables execution
    };
    pdpt[511][511] = (struct PDPTE){
        1,                            // present
        1,                            // Read/Write
        1,                            // Supervisor
        0,                            // write back
        ...
        1,                            // 1G page
        0,                            // nullbits
        (1l) << (30 - 12), // address (*1G) higher half
        0,                            // reserved nullbits
        0                             // enables execution
    };
    cr = (struct CR3){
